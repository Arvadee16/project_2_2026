...
{"sku": "CUJ-001","demand":500 ,"cost": 10},
{"sku": "BJB-002","demand":1000 ,"cost": 30}
...
#Question 1. The tier split does not change much.MTR has moved from tier B to tier A, whilst the newly added items BJB is in tier B ,and CUJ is in tier C.

#Question 2. Tier A items changed from 4 items to 3 items, tier B items remained at 3, and tier C items increased from 3 to 4 items. This shows that changing the threshold affects how items are classified, even if the demand and cost values remain the same.
